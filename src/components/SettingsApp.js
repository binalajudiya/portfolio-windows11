    ...
    return (
        ...
        >
            <motion.div
                ...
                className="inverse-toggle absolute z-10 bg-transparent border-2 border-gray-400 rounded-md text-sm text-gray-100 shadow-lg backdrop-blur-xl backdrop-filter leading-normal overflow-hidden"
            >
                                        ...
                                        {wallpapers.length > 0 && (
                                            <>
                                                {wallpapers.map((wallpaper, index) => (
                                                    ...
                                                    onClick={() => {
                                                        dispatch(setWallpaperActive(wallpaper));
                                                    }}
                                                    >
                                                        <img 
                                                        src={wallpaper}
